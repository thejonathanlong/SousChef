...
extension NSLayoutConstraint {
	static func constraintsPinningEdges(of view1: UIView, toEdgesOf view2: UIView, insetBy inset: CGFloat) -> [NSLayoutConstraint]  {
		let constraints = [
			view1.leadingAnchor.constraint(equalTo: view2.leadingAnchor, constant: inset),
			view1.trailingAnchor.constraint(equalTo: view2.trailingAnchor, constant: inset),
			view1.topAnchor.constraint(equalTo: view2.topAnchor, constant: inset),
			view1.bottomAnchor.constraint(equalTo: view2.bottomAnchor, constant: inset),
		]
