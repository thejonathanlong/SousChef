//
//  MultiPhotoSelectionCollectionViewController.swift
//  SousChef
//
//  Created by Jonathan Long on 4/27/18.
...
//MARK: - RecipePhotoSelectionViewController
class RecipePhotoSelectionViewController: UICollectionViewController {
	...
	static func commonInit(photoSelectionViewController: RecipePhotoSelectionViewController) {
		photoSelectionViewController.collectionView?.register(PhotoCollectionViewCell.self, forCellWithReuseIdentifier: String(describing: PhotoCollectionViewCell.self))
		photoSelectionViewController.collectionView?.allowsMultipleSelection = true
		photoSelectionViewController.collectionView?.backgroundColor = UIColor.white
	}
	
	override init(collectionViewLayout layout: UICollectionViewLayout) {
		super.init(collectionViewLayout: layout)
		RecipePhotoSelectionViewController.commonInit(photoSelectionViewController: self)
	}
	...
	private func updateItemSize() {
		...
		let desiredItemWidth: CGFloat = 150
		let columns: CGFloat = max(floor(viewWidth / desiredItemWidth), 2)
		let padding: CGFloat = SousChefStyling.standardMargin
...
extension RecipePhotoSelectionViewController: PHPhotoLibraryChangeObserver {
